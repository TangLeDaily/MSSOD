...
class MSJCA(nn.Module):
    def __init__(self):
        ...
        self.rgb_con1 = ResNet50_1()
        self.rgb_con2 = ResNet50_2()
        self.rgb_con3 = ResNet50_3()
        self.rgb_con4 = ResNet50_4()
        self.rgb_con5 = ResNet50_5()

        self.dep_con1 = ResNet50_1()
        self.dep_con2 = ResNet50_2()
        self.dep_con3 = ResNet50_3()
        self.dep_con4 = ResNet50_4()
        self.dep_con5 = ResNet50_5()

        self.JA1 = JointAttention(in_channel=64, ratio=16)
        self.JA2 = JointAttention(in_channel=256, ratio=16)
        self.JA3 = JointAttention(in_channel=512, ratio=16)
        self.JA4 = JointAttention(in_channel=1024, ratio=16)
        self.JA5 = JointAttention(in_channel=2048, ratio=16)
...
class MSSOD(nn.Module):
    def __init__(self, rfb_out_channel=32):
        ...
        self.CCA = CenterCombineAttention(in_channel=1024)
        ...
        self.agg_block_2 = PixUpBlock(64)
        self.agg_block_3 = PixUpBlock(64)
        ...
        self.last_conv = nn.Sequential(
            BasicBlock(16 * 4, 16 * 4),
            BasicBlock(16 * 4, 16 * 4),
            BasicBlock(16 * 4, 16 * 4),
        )
        self.out_conv = nn.Conv2d(4 * 4, 1, 3, 1, 1)
    ...
    def forward(self, low_input, high_input):
        ...
        # torch.Size([4, 16, 128, 128])
        # torch.Size([4, 16, 128, 128])
        sum_c = torch.cat((fa_3_c, fa_2_c, fa_1_c, center), dim=1) # c=64
