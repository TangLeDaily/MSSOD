...
class MSJCA(nn.Module):
    def __init__(self):
        ...
        self.JA1 = DCNJointAttention(in_channel=64, ratio=16)
        self.JA2 = DCNJointAttention(in_channel=64, ratio=16)
        self.JA3 = DCNJointAttention(in_channel=128, ratio=16)
        self.JA4 = DCNJointAttention(in_channel=256, ratio=16)
        self.JA5 = DCNJointAttention(in_channel=512, ratio=16)
