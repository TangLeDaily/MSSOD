...
class MSJCA(nn.Module):
    def __init__(self):
        ...
        self.rgb_VGG_con3 = VGG19_conv3()
        self.rgb_VGG_con4 = VGG19_conv4()
        self.rgb_VGG_con5 = VGG19_conv5_Nopool()

        self.dep_VGG_con1 = VGG_conv1()
        self.dep_VGG_con2 = VGG_conv2()
        self.dep_VGG_con3 = VGG19_conv3()
        self.dep_VGG_con4 = VGG19_conv4()
        self.dep_VGG_con5 = VGG19_conv5_Nopool()
