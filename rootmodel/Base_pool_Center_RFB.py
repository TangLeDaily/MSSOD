...
class RFBs(nn.Module):
    def __init__(self, c1, c2, c3):
        super(RFBs, self).__init__()
        self.RFB_1_1 = RFB(c1, c1)
        self.RFB_1_2 = RFB(c2, c2)
        self.RFB_1_3 = RFB(c3, c3)

        self.RFB_2_1 = RFB(c1, c1)
        self.RFB_2_2 = RFB(c2, c2)
        self.RFB_2_3 = RFB(c3, c3)

    def forward(self, rgb_3, rgb_4, rgb_5, depth_3, depth_4, depth_5):
        return self.RFB_1_1(rgb_3), self.RFB_1_2(rgb_4), self.RFB_1_3(rgb_5), self.RFB_2_1(depth_3), self.RFB_2_2(depth_4), self.RFB_2_3(depth_5)
...
class MSSOD(nn.Module):
    ...
    def forward(self, low_input, high_input):
        ...
        rgb_1, rgb_2, rgb_3, depth_1, depth_2, depth_3 = self.RFBs(rgb_1, rgb_2, rgb_3, depth_1, depth_2, depth_3)
